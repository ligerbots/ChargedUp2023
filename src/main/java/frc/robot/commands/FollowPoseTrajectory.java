...
//follows a trajectory to an inputted pose
public class FollowPoseTrajectory extends CommandBase {
    ...
    public FollowPoseTrajectory(DriveTrain driveTrain,
	...
	public void execute() {
        ...
        //whenever I get rid of PathPlannerState it gives me an error
