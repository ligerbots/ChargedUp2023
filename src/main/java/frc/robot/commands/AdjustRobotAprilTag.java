...
//this command adjusts robot to the AprilTag target(in the middle cube space)
public class AdjustRobotAprilTag extends InstantCommand {
    private final Vision m_vision;
    private final DriveTrain m_driveTrain;

    public AdjustRobotAprilTag(Vision vision, DriveTrain driveTrain) {
    ...
    public void initialize() { //should I still check if hasTargets?
		...
		double range = m_vision.getDistanceFromTarget(false); //range for AprilTag
