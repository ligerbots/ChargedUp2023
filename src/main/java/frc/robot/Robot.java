...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        m_chosenTrajectory.addOption("Charge Station Cone Wall", new AutoChargeStationOneConeOtherSide(driveTrain, arm, vision, claw, overrideButton, false));
        m_chosenTrajectory.addOption("Charge Station Cone Barrier", new AutoChargeStationOneConeOtherSide(driveTrain, arm, vision, claw, overrideButton, true));
